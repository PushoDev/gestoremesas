        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('money')
                    ...
                    ->default(0)
                    ->prefix('$'),
                Forms\Components\TextInput::make('id_families')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('id_messagers')
                    ->required()
                    ->numeric(),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('money')
                    ->money()
                    ->sortable(),
                Tables\Columns\TextColumn::make('id_families')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('id_messagers')
                    ->numeric()
                    ->sortable(),
